...
const translations = [
  ...
  ['.nav-links a:nth-child(2)', 'Our approach', '我们的理念'],
  ...
  ['.hero-copy-panel .hero-copy', 'As your neighbour, we’ll occasionally stop by with a little gift and lend a helping hand.', '作为你的邻居，我们会不定时给你送一些小礼物，为你提供帮助。'],
  ...
  ['#how .section-heading h2', 'Small software,<br>Big dream', '小而精，<br>值得长期信赖。'],
  ['#how .section-heading p', 'Our products may take different forms, but every one follows the same set of principles.', '产品形态可以不同，但每一款都遵守同一套 Neighbour 标准。'],
  ...
  ['#neighbourhoods .kicker', 'BUILT LIKE A GOOD NEIGHBOUR', '像一位值得信任的邻居'],
  ['#neighbourhoods h2', 'Simple,<br>never simplistic.', '简单，<br>但不简陋。'],
  ['#neighbourhoods p', 'We aim to be restrained, inclusive and honest: there when you need us, and still here when you return.', '我们希望成为克制、有分寸、包容、诚实的邻居：当你有需要时可以来找我们，当你再次回来时，我们依然在这里。'],
  ['.checks span:nth-child(1)', '✓ Beautiful, never showy', '✓ 优美，但不炫技'],
  ['.checks span:nth-child(2)', '✓ Smooth and dependable', '✓ 流畅，而且可靠'],
  ['.checks span:nth-child(3)', '✓ Maintained for the long term', '✓ 长期维护，值得再次回来'],
  ['.pin-one b', 'Focus', '聚焦'],
  ['.pin-two b', 'Experience', '体验'],
  ['.pin-three b', 'Trust', '信任'],
  ['.map-stat small', 'one clear<br>product standard', '一套清晰的<br>产品标准'],

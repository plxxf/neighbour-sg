...
const translations = [
  ...
  ['.mini-guard b', 'Protect what matters', '守护真正重要的信息'],
  ['.mini-guard small', 'Privacy · Security · Trust', '隐私 · 安全 · 信任'],
  ['.mini-care b', 'Stay close after launch', '发布之后依然陪伴'],
  ['.mini-care small', 'Support · Listen · Evolve', '支持 · 倾听 · 成长'],

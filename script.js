...
const translations = [
  ...
  ['.mini-message b', 'Insight first, clarity always', '洞察所需，清晰呈现'],
  ['.mini-message small', 'Focus · Utility · Restraint', '聚焦 · 实用 · 克制'],
  ['.mini-reply b', 'Observe the evidence, inform the decision', '尊重事实，循证而行'],
  ['.mini-reply small', 'Research · Validate · Apply', '调研 · 验证 · 实践'],
  ['.mini-insight b', 'Measure with care, improve with purpose', '持续迭代，精益求进'],
  ['.mini-insight small', 'Measure · Learn · Refine', '衡量 · 学习 · 改进'],
  ['.mini-guard b', 'Protect the data, preserve the trust', '守护信息，捍卫信任'],
  ['.mini-guard small', 'Privacy · Security · Reliability', '隐私 · 安全 · 可靠'],
  ['.mini-care b', 'Present at launch, there for the journey', '始于交付，久于陪伴'],
  ['.mini-care small', 'Listen · Support · Grow', '倾听 · 支持 · 共进'],
  ...
  ['.footer > p', 'No need to thank us. We’re neighbours.', '不用客气，邻里之间。'],
